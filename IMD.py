...
test = reaggregator("SOA2001", "LSOA2011", ldn_df, IMD_2004_df)
##### CHECK ALL COLUMNS ARE SUMMING CORRECTLY
##### DROP GID COLUMN
...
# IMD_2010_df = IMD_2010_df.rename(columns={"LSOA CODE": "LSOA2011", "IMD SCORE": "IMD score", "INCOME SCORE": "income score",
#                                           "EMPLOYMENT SCORE": "employment score"})
...
# IMD_2015_df = IMD_2015_df[["LSOA code (2011)", "LSOA name (2011)", "Index of Multiple Deprivation (IMD) Score", "Income Score (rate)",
...
# IMD_2019_df = IMD_2019_df[["LSOA code (2011)", "LSOA name (2011)", "Index of Multiple Deprivation (IMD) Score", "Income Score (rate)",
#                            "Employment Score (rate)"]]
